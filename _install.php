...
?>	    </div>
	    ...
	    <div class="well">
	    	...
	    	<p>Also, don't forget to read our <a href="http://nullrefer.com/?https://sendy.co/get-started" target="_blank" style="text-decoration:underline;">Get Started Guide</a> to help you get Sendy up and running.</p>
	    </div>
    </div>
    <div class="span9">
	    ...
	    <form action="" method="POST" accept-charset="utf-8" class="form-vertical">
	    	...
	    	<div class="control-group">
		    	<div class="controls">
	              <input type="text" class="input-xlarge" id="license" name="license" value="Nulled-By-fire2000" readonly>
	            </div>
	        </div>
